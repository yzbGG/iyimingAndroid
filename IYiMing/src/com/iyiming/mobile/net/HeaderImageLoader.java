/**   
* @Title: HeaderImageLoader.java 
* @Package com.iyiming.mobile.net 
* @Description: TODO(用一句话描述该文件做什么) 
* @author dkslbw@gmail.com   
* @date 2014年11月26日 下午5:45:47 
* @version V1.0   
*/
package com.iyiming.mobile.net;

/** 
 * @ClassName: HeaderImageLoader 
 * @Description: TODO(允许带header的imageloader) 
 * @author dkslbw@gmail.com
 * @date 2014年11月26日 下午5:45:47 
 *  
 */
 ...
 *
 * The simple way to use this class is to call {@link HeaderImageLoader#get(String, ImageListener)}
 * and to pass in the default image listener provided by
 * {@link HeaderImageLoader#getImageListener(ImageView, int, int)}. Note that all function calls to
...
public class HeaderImageLoader {
     ...
     */
    public HeaderImageLoader(RequestQueue queue, ImageCache imageCache) {
        mRequestQueue = queue;
        mCache = imageCache;
    }
     ...
     * If the default was returned, the {@link HeaderImageLoader} will be invoked when the
